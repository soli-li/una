...
public class ConsolePrintStream extends PrintStream {
  private static class PrintFunctional {
    public void print(final boolean error, final boolean outConsole, final Object value, final PrintFunctionalInterface func) {
      if (outConsole) {
        func.apply();
      }
  ...
  private static class PrintlnFunctional {
    public void println(final boolean error, final boolean outConsole, final boolean emptyPringln, final Object value, final PrintFunctionalInterface func) {
      if (outConsole) {
        func.apply();
      }
      else {
