...
public class InitializationSetup {
  private static class InitializerEnvironmentPreparedListener
    ...
    public void onApplicationEvent(final ApplicationEnvironmentPreparedEvent event) {
      ...
      final boolean outConsole = Boolean
          .parseBoolean(environment.getProperty(InitializationSetup.OUT_CONSOLE_KEY)); // 是否输出到控制台
  ...
  // system.out/err是否输出到控制台
  private static final String OUT_CONSOLE_KEY = "app.stdout.printToConsole";
  private static List<String> beforeInitializeInformation = new LinkedList<>();

  public static SpringApplication getSpringApplication(final String[] args,
      final Collection<Class<?>> additionalPrimarySources) {
