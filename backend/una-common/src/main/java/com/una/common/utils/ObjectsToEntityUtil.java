...
public final class ObjectsToEntityUtil {
  ...
  public static class Transform7<T1, T2, T3, T4, T5, T6, T7>
      extends Transform6<T1, T2, T3, T4, T5, T6> {
  ...
  public static class Transform8<T1, T2, T3, T4, T5, T6, T7, T8>
      extends Transform7<T1, T2, T3, T4, T5, T6, T7> {
  ...
  public static class Transform9<T1, T2, T3, T4, T5, T6, T7, T8, T9>
      extends Transform8<T1, T2, T3, T4, T5, T6, T7, T8> {
  ...
  public static <T1, T2, T3, T4, T5> Transform5<T1, T2, T3, T4, T5> getTransform5(
      final Object[] objs) {
  ...
  public static <T1, T2, T3, T4, T5, T6> Transform6<T1, T2, T3, T4, T5, T6> getTransform6(
      final Object[] objs) {
  ...
  public static <T1, T2, T3, T4, T5, T6, T7> Transform7<T1, T2, T3, T4, T5, T6, T7> getTransform7(
      final Object[] objs) {
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8>
      Transform8<T1, T2, T3, T4, T5, T6, T7, T8> getTransform8(
      final Object[] objs) {
    // @formatter:on
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9>
      Transform9<T1, T2, T3, T4, T5, T6, T7, T8, T9> getTransform9(
      final Object[] objs) {
    // @formatter:on
