...
public class PaginationInfo<T> {
  ...
  public static <E> PaginationInfo<E> of(final int pageNumber, final int pageSize,
      final boolean pageable, final List<E> dataList, final long total) {
    if (pageable) {
  ...
  private static <E> PaginationInfo<E> of(final int pageNumber, final int pageSize,
      List<E> dataList, final long total) {
