...
public class GroupController {
  ...
  @ResponseBody
  public boolean exist(final HttpServletRequest request, final String name, final String companyId)
      throws Exception {
  ...
  @ResponseBody
  public Set<Group> findByRole(final HttpServletRequest request,
  ...
  @RequestMapping(value = "findByUser",
      ...
      consumes = MimeTypeUtils.APPLICATION_JSON_VALUE)
  @ResponseBody
  public Set<Group> findByUser(final HttpServletRequest request,
  ...
  @RequestMapping(value = "search",
      ...
      consumes = MimeTypeUtils.APPLICATION_JSON_VALUE)
  @ResponseBody
  public PaginationInfo<Group> search(final HttpServletRequest request,
      @RequestBody final SearchGroup searchGroup) throws Exception {
