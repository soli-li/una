...
public class MenuController {
  ...
  public Set<Menu> current(final HttpServletRequest request) throws Exception {
    ...
    final Set<String> permissionsIds = this.objectMapper.readValue(permIds, typeRef);
  ...
  public void save(final HttpServletRequest request, final HttpServletResponse response,
      @RequestBody final Menu menu) throws Exception {
  ...
  @RequestMapping(value = "search",
      ...
      consumes = MimeTypeUtils.APPLICATION_JSON_VALUE)
  @ResponseBody
  public PaginationInfo<Menu> search(final HttpServletRequest request,
      @RequestBody final SearchMenu searchMenu) throws Exception {
