...
public class UrlPermController {
  ...
  public void save(final HttpServletRequest request, final HttpServletResponse response,
      @RequestBody final UrlPerm urlPerm) throws Exception {
  ...
  @RequestMapping(value = "search",
      ...
      consumes = MimeTypeUtils.APPLICATION_JSON_VALUE)
  @ResponseBody
  public PaginationInfo<UrlPerm> search(final HttpServletRequest request,
      @RequestBody final SearchUrlPerm searchUrlPerm) throws Exception {
