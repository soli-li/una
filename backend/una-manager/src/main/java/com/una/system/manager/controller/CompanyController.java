...
public class CompanyController {
  ...
  @ResponseBody
  public boolean existName(final HttpServletRequest request,
    ...
    Assert.isTrue(!allBlank && !allHasText,
        "one of parameter 'name' and 'shortName' must not be empty");
  ...
  public void save(final HttpServletRequest request, final HttpServletResponse response,
      @RequestBody final Company company) throws Exception {
    ...
    try {
      ...
      this.configurationController.refresh(request);
  ...
  @RequestMapping(value = "search",
      ...
      consumes = MimeTypeUtils.APPLICATION_JSON_VALUE)
  @ResponseBody
  public PaginationInfo<Company> search(final HttpServletRequest request,
      @RequestBody final SearchCompany searchCompany) throws Exception {
    ...
    searchCompany.setEqShortNamd(StringUtils.defaultIfBlank(searchCompany.getEqShortNamd(), null));
