...
public class PasswordPolicyService {
  ...
  public void save(final PasswordPolicy passwordPolicy, final String userId) {
    ...
    passwordPolicy.setDescription(
        StringUtils.defaultString(passwordPolicy.getDescription(), "").replaceAll("\t", ""));
    PasswordPolicyService.LOGGER.info("save or update password policy object -> "
        + "already checked password policy value, ready save");
