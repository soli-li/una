  ...
  @Query(nativeQuery = false,
      value = """
          ...
          WHERE (:allow = TRUE OR c.id = :id)
                ...
                AND (:#{#sc.legalPerson} IS NULL
                    OR UPPER(c.legalPerson) LIKE UPPER(:#{#sc.legalPerson}))
                ...
                AND (:#{#sc.eqShortNamd} IS NULL OR UPPER(c.shortName) = UPPER(:#{#sc.eqShortNamd}))
          """)
  Page<Object[]> search(@Param("sc") SearchCompany searchCompany, @Param("id") String companyId,
