...
public class MenuControllerTest extends ManagerApplicationTests {
  @Autowired
...
""";
  ...
  public void saveOnError5() throws Exception {
    final Menu menu = new Menu();
    menu.setName("test 1");
    menu.setRemark("test");
    menu.setFrontEndUri("/test");
  ...
  public void saveOnError6() throws Exception {
    final Menu menu = new Menu();
    menu.setId(this.getConfigMenuId());
    menu.setName("test 1");
    menu.setRemark("test");
  ...
  public void saveOnError7() throws Exception {
    final Menu menu = new Menu();
    menu.setId(this.getConfigMenuId());
    menu.setName("test 1");
    menu.setRemark("test");
