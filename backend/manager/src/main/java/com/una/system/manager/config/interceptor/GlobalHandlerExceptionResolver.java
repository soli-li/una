...
public class GlobalHandlerExceptionResolver {
  ...
  @ResponseBody
  public String handlerException(final HttpServletRequest request, final HttpServletResponse response, final Exception ex) {
    ...
    GlobalHandlerExceptionResolver.LOGGER.error("request exception, uri: {}, marks: {}, ex class: {}", request.getRequestURI(), marks, ex.getClass().getName(),
      ex);
    try {
      ...
      GlobalHandlerExceptionResolver.LOGGER.error("ExceptionResponse cannot serialization, mark: {}, msg: {}", exRes.getMark(), exRes.getMsg(), e);
