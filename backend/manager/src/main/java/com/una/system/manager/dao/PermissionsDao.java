...
public interface PermissionsDao extends BaseRepository<Permissions, String> {
  ...
  @Query(nativeQuery = true, value = """
    SELECT P.ID, P.NAME, P.STATUS, P.REMARK, P.CREATED_USER_ID, P.CREATED_DATE, P.UPDATED_USER_ID, P.UPDATED_DATE
  ...
  VALUES(?1, ?2, ?3, ?4, ?5);
    """)
  void saveRoleRelation(String id, String roleId, String permId, String createdUserId, LocalDateTime dateTime);
