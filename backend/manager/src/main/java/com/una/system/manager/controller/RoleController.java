...
public class RoleController {
  ...
  @ResponseBody
  public boolean exist(final HttpServletRequest request, final String authority, final String companyId) throws Exception {
  ...
  @ResponseBody
  public Set<Role> findByGroup(final HttpServletRequest request, @RequestBody final List<String> groups) throws Exception {
  ...
  @ResponseBody
  public Set<Role> findByPerm(final HttpServletRequest request, final HttpServletResponse response, @RequestBody final PermissionsRelation permissionsRelation)
    throws Exception {
    String companyId = RequestUtils.getCompanyId(request, this.requestHeadKey);
    final boolean allowNotCompanyCond = RequestUtils.hasSpecId(request.getHeader(this.requestHeadKey.getPermIdKey()), this.objectMapper,
      this.specialId.getNotIncludeCompanyId());
    ...
    return this.roleService.findByPerm(permissionsRelation.getPermissionsList(), permissionsRelation.getCompanyId());
  }

  @RequestMapping(value = "findByUser", method = RequestMethod.POST, consumes = MimeTypeUtils.APPLICATION_JSON_VALUE)
  @ResponseBody
  public Set<Role> findByUser(final HttpServletRequest request, @RequestBody final List<String> users) throws Exception {
    String companyId = RequestUtils.getCompanyId(request, this.requestHeadKey);
    final boolean allowNotCompanyCond = RequestUtils.hasSpecId(request.getHeader(this.requestHeadKey.getPermIdKey()), this.objectMapper,
      this.specialId.getNotIncludeCompanyId());
    if (allowNotCompanyCond) {
  ...
  @ResponseBody
  public void save(final HttpServletRequest request, final HttpServletResponse response, @RequestBody final Role role) throws Exception {
  ...
  @ResponseBody
  public PaginationInfo<Role> search(final HttpServletRequest request, @RequestBody final SearchRole searchRole) throws Exception {
    ...
    final Set<String> permIdsSet = this.objectMapper.readValue(Optional.ofNullable(request.getHeader(this.requestHeadKey.getPermIdKey())).orElse("[]"),
      new TypeReference<Set<String>>() {
      });
    final boolean allowNotCompanyCond = permIdsSet.contains(this.specialId.getNotIncludeCompanyId());
  ...
  @ResponseBody
  public void updateRelation(final HttpServletRequest request, final HttpServletResponse response, @RequestBody final Role role) throws Exception {
    final String userId = RequestUtils.getUserId(request, this.requestHeadKey);
  ...
  @RequestMapping(value = "updateRelationForPerm", method = RequestMethod.POST, consumes = MimeTypeUtils.APPLICATION_JSON_VALUE)
  @ResponseBody
  public void updateRelationForPerm(final HttpServletRequest request, final HttpServletResponse response, @RequestBody final Role role) throws Exception {
    final String userId = RequestUtils.getUserId(request, this.requestHeadKey);
