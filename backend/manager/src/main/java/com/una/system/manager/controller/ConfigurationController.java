...
public class ConfigurationController {
  ...
  @ResponseBody
  public boolean exist(final HttpServletRequest request, final String companyId, final String key) throws Exception {
  ...
  @RequestMapping(value = "refresh", method = RequestMethod.POST, consumes = MimeTypeUtils.TEXT_PLAIN_VALUE)
  @ResponseBody
  ...
  @ResponseBody
  public void save(final HttpServletRequest request, final HttpServletResponse response, @RequestBody final Configuration configuration) throws Exception {
    ...
    if (!StringUtils.equals("test", this.active)) {
      List<Configuration> configurationList = this.sharingService.getConfigurationList(configuration.getCompanyId());
  ...
  @ResponseBody
  public PaginationInfo<Configuration> search(final HttpServletRequest request, @RequestBody final SearchConf searchConf) throws Exception {
